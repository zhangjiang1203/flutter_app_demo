...
class ChangeNotifierProvider<T extends ChangeNotifier> extends StatefulWidget {
  ...
  static T of<T>(BuildContext context,{bool listener = true}) {
    ...
    final provider = listener ? context.inheritFromWidgetOfExactType(type) as CommonInheritedProvider<T>
        : context.ancestorInheritedElementForWidgetOfExactType(type).widget as CommonInheritedProvider<T>;
